...
//        private const string EXCEPTIONS_ON_STARTUP = "Startup";
//        private const string EXCEPTIONS_ON_CONFIGURE_SERVICES = "ConfigureServices";
//        private const string EXCEPTIONS_ON_CONFIGURE = "Configure";

//        private readonly Dictionary<string, List<Exception>> _exceptions;

//        public Startup_V8(IConfiguration configuration, IHostingEnvironment env)
//        {
//            _exceptions = new Dictionary<string, List<Exception>>{
//                { EXCEPTIONS_ON_STARTUP, new List<Exception>() },
//                { EXCEPTIONS_ON_CONFIGURE_SERVICES, new List<Exception>() },
//                { EXCEPTIONS_ON_CONFIGURE, new List<Exception>() },
//            };
...
//            catch (Exception ex)
//            {
//                _exceptions[EXCEPTIONS_ON_STARTUP].Add(ex);
//            }
//        }
...
//            catch (Exception ex)
//            {
//                _exceptions[EXCEPTIONS_ON_CONFIGURE_SERVICES].Add(ex);
//            }
//        }
...
//            catch (Exception ex)
//            {
//                _exceptions[EXCEPTIONS_ON_CONFIGURE].Add(ex);
//            }
